package patterns.rest.repository.dao.template;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Component;
import patterns.rest.exception.DataException;
import patterns.rest.model.entity.Movie;
import patterns.rest.repository.dao.provider.ProxyConnection;
import patterns.rest.service.mapper.result.MovieResultSetMapper;
...
import static patterns.rest.repository.dao.provider.DbManager.getConnection;
import static patterns.rest.repository.dao.template.Query.INSERT_MOVIE;
import static patterns.rest.repository.dao.template.Query.SELECT_ALL_MOVIE;
import static patterns.rest.repository.dao.template.Query.SELECT_BY_TITLE;
