...
import patterns.example.dao.mapper.result.MovieResultSetMapper;
...
import static patterns.example.dao.template.Query.INSERT_MOVIE;
import static patterns.example.dao.template.Query.SELECT_ALL_MOVIE;
import static patterns.example.dao.template.Query.SELECT_BY_TITLE;
